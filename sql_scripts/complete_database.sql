...
INSERT INTO workouts (name_of_training_session, last_name, first_name, middle_name, description, duration_minutes, max_participants, difficulty_level) VALUES
('Йога для начинающих', 'Иванов', 'Александр', 'Петрович', 'Мягкая практика для новичков', 60, 15, 'Начинающий'),
('Пилатес', 'Петрова', 'Мария', 'Сергеевна', 'Укрепление мышц кора', 45, 12, 'Средний'),
('Кроссфит', 'Сидоров', 'Дмитрий', 'Александрович', 'Высокоинтенсивные тренировки', 60, 10, 'Продвинутый'),
('Стретчинг', 'Козлова', 'Елена', 'Владимировна', 'Растяжка и гибкость', 45, 20, 'Начинающий'),
('Бодибилдинг', 'Новиков', 'Сергей', 'Игоревич', 'Набор мышечной массы', 90, 8, 'Продвинутый'),
('Кардио-тренировка', 'Морозова', 'Анна', 'Дмитриевна', 'Улучшение выносливости', 45, 15, 'Средний'),
('Бокс', 'Волков', 'Игорь', 'Сергеевич', 'Техника ударов и защита', 60, 12, 'Средний'),
('Танцевальная аэробика', 'Соколова', 'Ольга', 'Андреевна', 'Танцы под музыку', 45, 18, 'Начинающий'),
('Плавание', 'Лебедев', 'Павел', 'Николаевич', 'Техника плавания', 60, 8, 'Средний'),
('Степ-аэробика', 'Козлова', 'Наталья', 'Ивановна', 'Тренировка на степ-платформе', 45, 16, 'Средний'),
('Кикбоксинг', 'Смирнов', 'Андрей', 'Петрович', 'Комбинация бокса и карате', 60, 10, 'Продвинутый'),
('Зумба', 'Попова', 'Юлия', 'Александровна', 'Латиноамериканские танцы', 45, 20, 'Начинающий'),
('Тяжелая атлетика', 'Васильев', 'Владимир', 'Сергеевич', 'Работа с весами', 90, 6, 'Продвинутый'),
('Функциональный тренинг', 'Семенова', 'Татьяна', 'Игоревна', 'Комплексные упражнения', 60, 12, 'Средний'),
('Беговая тренировка', 'Голубев', 'Михаил', 'Дмитриевич', 'Техника бега', 45, 15, 'Средний'),
('Степ-аэробика продвинутый', 'Виноградова', 'Екатерина', 'Андреевна', 'Сложные комбинации', 60, 12, 'Продвинутый'),
('Карате', 'Белов', 'Артем', 'Сергеевич', 'Боевое искусство', 60, 14, 'Средний'),
('Пилатес продвинутый', 'Медведева', 'Ирина', 'Петровна', 'Сложные упражнения', 60, 10, 'Продвинутый'),
('Тренажерный зал', 'Алексеев', 'Денис', 'Николаевич', 'Индивидуальные тренировки', 60, 1, 'Средний'),
('Йога продвинутый', 'Лебедева', 'Светлана', 'Ивановна', 'Сложные асаны', 75, 12, 'Продвинутый');
